...
function initGame(){
	// display intro
	$("#question").html('When you play Trivia of Thrones, you win or you die. Okay, so you won\'t actually die, but some of these questions are very difficult, and you only have 10 seconds to answer, not enough time to google it! Good luck, and <em>Valar Morghulis</em>.<button id="startGame">Begin Game</button>');
	$("#result").hide();
	$("#choices li").empty();
	$(".scoreBoard").empty();
	//add listeners
